INSERT INTO `question` VALUES (1,'2018-03-21 00:00:00'
,'很多人觉得技术的工资是虚高的泡沫，也有人觉得程序员就是这个时代不可或缺的关键人才……不知道天码营的各位是怎么看待互联网开发这个行业呢？'
,'提问：对于互联网开发或者是俗称码农这个行业，天码营是如何看待的？'),(2,'2018-03-21 11:47:29'
,'RT，谢谢：）'
,'求问David老师，怎么系统地入门Java框架'),(3,'2018-03-22 11:54:10'
,'对想转行计算机专业的同学有什么建议。这里也有一位从北大化学华丽转身的[同学](https://www.tianmaying.com/qa/6217823a-0e98-46d9-aeb0-960b0a1b25d8)，是否有同感？'
,'从北大物理系转到CS，再到横扫前端各种职位拿Special Offer拿到手软，你是怎么做到的？'),(4,'2018-03-22 11:56:22'
,'二者可以结合使用么，在spring体系中概念上二者是怎样的一个关系'
,'spring -boot和spring-mvc是两个平行的框架么?'),(5,'2018-03-23 12:00:25'
,'如下代码：\r\n\r\n```\r\n@Component\r\npublic class Sample {\r\n\r\n    @Value(\"${my.name}\")\r\n    public static String name;\r\n\r\n}\r\n```\r\n\r\n运行后name总是null。静态变量应该如何注入呢？或者说注入静态变量是不是一种好的方式，有没有其他方式处理类似场景。'
,'Spring中如何注入静态变量？'),(6,'2018-03-24 12:02:20'
,''
,'请问web前端开发除了需要学习就是js，jq，html+css，还需要掌握哪些知识才能胜任这份工作？还有web开发流程是怎样的？'),(7,'2018-03-24 12:04:07'
,'大学和研究生课程比较少前端方面的东西，做前端开发更多都是基于个人兴趣，你怎么看？'
,'求职Web前端工作需要掌握哪些技能？到怎样的一个水平？'),(8,'2018-03-24 12:06:27'
,'如题，网上一般说angular和jquery是冲突的，他们是冲突的吗，可以配合使用吗'
,'angular和jquery可以同时使用吗'),(9,'2018-03-23 12:08:10'
